        ...
        try:
            ...
            try:
                ...
                if packet_count is not None and packet_count > 0:
                    sniff_kwargs["count"] = int(packet_count)
                ...
                while self.running:
                    ...
                    # AsyncSniffer exits automatically when count is reached.
                    if packet_count and not sniffer.running:
                        self.logger.info("Packet capture count reached: %s", packet_count)
                        break
