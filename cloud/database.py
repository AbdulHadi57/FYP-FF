...
def _init_schema(conn):
    ...
    conn.execute("""
        CREATE TABLE IF NOT EXISTS action_approvals (
            ...
            note TEXT,
            created_at TEXT DEFAULT CURRENT_TIMESTAMP,
            FOREIGN KEY(action_id) REFERENCES action_jobs(id) ON DELETE CASCADE
        )
    """)
    ...
    conn.execute("""
        CREATE TABLE IF NOT EXISTS agent_dc_bindings (
            ...
            FOREIGN KEY(dc_id) REFERENCES domain_controllers(id) ON DELETE CASCADE
        )
    """)
