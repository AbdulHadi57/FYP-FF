...
export default function RawData({ selectedFlowId, api = '' }) {
    ...
    const fetchFlows = async (isPoll = false) => {
        ...
        try {
            ...
            if (isPoll && !isFiltering && currentFlows.length > 0) {
                const maxId = Math.max(...currentFlows.map(f => f.id));
                ...
                <div className="flex flex-col gap-4 mb-6">
                    ...
                    <div className="bg-surface/50 p-4 rounded-lg border border-white/5 flex flex-wrap gap-4 items-end">
                        ...
                        <div className="flex flex-col gap-1 flex-1 min-w-[200px]">
                            ...
                            {['verdict', 'ja4_pred'].includes(newFilterCol) ? (
                                <select
